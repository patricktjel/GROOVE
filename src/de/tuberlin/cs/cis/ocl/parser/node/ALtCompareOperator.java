...
public final class ALtCompareOperator extends PCompareOperator
{
    private TLt _lt_;

    public ALtCompareOperator()
    {
        // Constructor
    }
    ...
    {
        ((Analysis) sw).caseALtCompareOperator(this);
    }
