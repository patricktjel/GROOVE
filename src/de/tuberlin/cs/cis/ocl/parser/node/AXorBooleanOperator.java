...
public final class AXorBooleanOperator extends PBooleanOperator
{
    private TXor _xor_;

    public AXorBooleanOperator()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AXorBooleanOperator(
    ...
    {
        ((Analysis) sw).caseAXorBooleanOperator(this);
    }
