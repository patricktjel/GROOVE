...
public final class ASimpleTypeSpecifier extends PSimpleTypeSpecifier
{
    private PPathName _pathName_;

    public ASimpleTypeSpecifier()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ASimpleTypeSpecifier(
    ...
    {
        ((Analysis) sw).caseASimpleTypeSpecifier(this);
    }
