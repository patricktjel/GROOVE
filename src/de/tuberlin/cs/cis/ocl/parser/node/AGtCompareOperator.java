...
public final class AGtCompareOperator extends PCompareOperator
{
    private TGt _gt_;

    public AGtCompareOperator()
    {
        // Constructor
    }
    ...
    {
        ((Analysis) sw).caseAGtCompareOperator(this);
    }
